...
function Login() {
  return (
    <div className="min-h-screen bg-gray-100 flex w-full px-30 text-[#425B90]">
        <div  className='w-[100%] flex justify-center items-center'>
            <Image src={LoginImage} alt='login Image' className='w-[50%]'/>
        </div>
       <form className="lg:mr-[5%] xl:mr-[10%] max-w-[28rem] xl:max-w-[30rem] flex flex-col gap-y-4 md:gap-y-5 justify-center min-h-screen p-4 w-[100%]">
        ...
        <div className="space-y-5 w-full max-w-md">
          <div className="relative ">
            ...
            <input type="email" placeholder="Email" className="w-full px-12 h-12 appearance-none outline-none  focus:ring-0 border-[1px] border-[#9FD4EF]/50 rounded-lg focus:shadow-md text-lg placeholder:text-[#9FD4EF]" />
          </div>
          <div className="relative ">
            <div className="absolute inset-0 my-auto left-5 size-6">
